...
const CustomPizza = () => {
  ...
  return (
    <div className="woodbg overflow-hidden w-full h-screen sm:h-[640px] lg:h-screen relative bg-cover py-4 xs:py-8">
      ...
      <div className="absolute w-full text-center mb-4 xs:mt-[80px] sm:mt-0 flex flex-col justify-center">
        <h1 className="relative text-5xl sm:text-6xl 2xl:text-8xl text-[#FF1842] mb-1 z-[51]">Create your own Pizza!</h1>
